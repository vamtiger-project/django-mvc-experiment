...
WebPage.prototype.getHtml = function () {
	...
	function getData() { // Variables containing or to store data
		...
		function getDialogBoxData() {
			...
			function initialize() {
					...
					if (!("invalidRequiredFields" in webPage.html.data.dialogBox)) {
						webPage.html.data.dialogBox.invalidRequiredFields = new function () {
							...
							this.figure = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, invalidRequiredFieldsDialogAttentionFigure, "left"),
							...
							this.message = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, invalidRequiredFieldsDialogMessage, "left"),
							...
							this.buttons = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, invalidRequiredFieldsDialogButtonBox, "left"),
							...
							this.dialog = new function () {
								...
								this.position = {
									left: getCenteredLeftPosition(webPage.html.data.dialogBox.position.center.left, dialogData.size.width, "left"),
									top: getCenteredLeftPosition(webPage.html.data.dialogBox.position.center.top, dialogData.size.height, "top"),
								}
							};
						};
					}
				...
				function gigInfoExists() {
					if (!("gigInfoExists" in webPage.html.data.dialogBox)) {
						webPage.html.data.dialogBox.gigInfoExists = new function () {
							...
							this.figure = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoExistsDialogAttentionFigure, "left"),
									top: webPage.html.data.dialogBox.padding,
								};
							};
							...
							this.message = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoExistsDialogMessage, "left"),
							...
							this.buttons = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoExistsDialogButtonBox, "left"),
				...
				function gigInfoUpdated() {
					if (!("gigInfoUpdated" in webPage.html.data.dialogBox)) {
						webPage.html.data.dialogBox.gigInfoUpdated = new function () {
							...
							this.figure = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoUpdatedDialogSuccessFigure, "left"),
									top: webPage.html.data.dialogBox.padding,
								};
							};
							...
							this.message = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoUpdatedDialogMessage, "left"),
							...
							this.buttons = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoUpdatedDialogButtonBox, "left"),
				...
				function gigInfoSaved() {
					if (!("gigInfoSaved" in webPage.html.data.dialogBox)) {
						webPage.html.data.dialogBox.gigInfoSaved = new function () {
							...
							this.figure = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoSavedDialogSuccessFigure, "left"),
									top: webPage.html.data.dialogBox.padding,
								};
							};
							...
							this.message = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoSavedDialogMessage, "left"),
							...
							this.buttons = new function () {
								this.position = {
									left: getCenteredLeftPosition(currentData.position.center.left, gigInfoSavedDialogButtonBox, "left"),
				...
				function gigInfoPublish() {
					if (!("gigInfoPublish" in webPage.html.data.dialogBox)) {
						webPage.html.data.dialogBox.gigInfoPublish = new function () {
							var currentData = this;
							var gigInfoPublishDialogFigure = webPage.html.selection("gigInfoPublishDialogFigure");
							var gigInfoPublishDialogButtonBox = webPage.html.selection("gigInfoPublishDialogButtonBox");

							this.position = new function () {
								this.center = {
									left: gigInfoPublishDialogFigure.offsetWidth / 2,
								};
							};
							...
							this.buttons = new function () {
								this.position = {
									...
									top: gigInfoPublishDialogFigure.offsetHeight + (webPage.html.data.dialogBox.padding * 2),
								};
							}
							...
							this.dialog = new function () {
								...
								this.size = {
									width: gigInfoPublishDialogFigure.offsetWidth,
				...
				function gigInfoPublishWeb() {
					if (!("gigInfoPublishWeb" in webPage.html.data.dialogBox)) {
						webPage.html.data.dialogBox.gigInfoPublishWeb = new function () {
							var currentData = this;
							var gigInfoPublishWebDialogFigure = webPage.html.selection("gigInfoPublishWebDialogFigure");
				...
				function getCenteredLeftPosition(referencePoint, target, position) {
	...
	function getSelection(selectionName) {
		...
		var setSelection = {
			...
			gigInfoPublishDialogFigure: gigInfoPublishDialogFigure,
			...
			gigInfoPublishWebDialogFigure: gigInfoPublishWebDialogFigure,
		...
		function gigInfoPublishDialogFigure() {
		...
		function gigInfoPublishWebDialogFigure() {
		...
		function gigInfoPublishWebDialogPublishButton() {
			selection = webPage.html.body.$dialogBox[0].querySelector(":scope > article[data-type=gigInfoPublishWeb] > section > span > input");
		}
...
WebPage.prototype.updateUi = function (info) {
	...
	function dialogBox() {
		...
		function showPublishWebPageDialog() {
			...
			setTimeout(function () {
				...
				function position() {
					...
					$(webPage.html.selection("gigInfoPublishWebDialogFigure")).css({
		...
		function publishWebPage() {
			var publishWebStartDate = getPublishStartDate();
			...
			$.ajax({
				...
				data: {
					publishWebStartDate: publishWebStartDate,
				},
			});

			function getPublishStartDate() {
				publishWebStartDate = webPage.html.selection("gigInfoPublishDialogDateInput").value;

				if (webPage.regex.nothing.test(publishWebStartDate)) {
					publishWebStartDate = webPage.regex.isoDate.exec(new Date().toISOString())[0];
				}

				return publishWebStartDate;
			}
			...
			function publishWebSite(gigsToPublish) {
				...
				function publishGigGuide() {
					...
					function publishWebPage(webPagePublicationInfo) {
						console.log(webPagePublicationInfo);
					}
